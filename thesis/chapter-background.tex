...
\label{chap:hardware}
    ...
    \label{sec:dtp}
        ...
        \label{subsec:type-systems}
            ...
            %% TODO: the "road to" dependent types. GIVE EXAMPLES
        ...
        \label{subsec:dependent-types}
            ...
            To achieve this goal, we define a datatype \AgdaDatatype{Fin} \AgdaBound{n}.
            of natural numbers smaller than \texttt{n}.
            \begin{listing}
                \ExecuteMetaData[agda/latex/Report/ChapterBackground.tex]{Fin}
            \end{listing}

            With this definition, \AgdaDatatype{Fin} \AgdaNumber{0} is a type with no elements,
            while \AgdaDatatype{Fin} \AgdaNumber{1} has 1 element (\AgdaInductiveConstructor{zero}),
            \AgdaDatatype{Fin} \AgdaNumber{2} has 2 elements
            (\AgdaInductiveConstructor{zero} and \AgdaInductiveConstructor{suc} \AgdaInductiveConstructor{zero}),
            and so forth\ldots Thus, the elements of \AgdaDatatype{Fin} \AgdaBound{n} \emph{correspond}
            to natural numbers smaller than \AgdaBound{n}.
            ...
            %% TODO: introduce logical interpretations for the cube's systems,
