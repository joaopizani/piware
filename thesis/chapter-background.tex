...
\label{chap:background}
    ...
    \label{sec:hardware-dtp}
        ...
        \label{subsec:coquet}
            ...
            Coquet~\cite{coquet2011}, a \ac{DSL} for hardware embedded in the Coq
            ...
            Some differences between Coquet's \mintinline{coq}{Circuit} and that of Π-Ware
            (detailed in Section~\ref{sec:circuit-syntax}) are immediately noticeable:
            ...
            \begin{description}
                \item[Indices are \mintinline{coq}{Type}s, instead of just sizes]
                    ...
                    representing the \emph{sizes} of the circuits input and output.
                    In Coquet, the indices are arbitrary types, \emph{constrained} by the
                    \mintinline{coq}{Fin} \emph{type class}.
                    The definition of \mintinline{coq}{Fin} makes synthesis of Coquet's circuits
                    \emph{interfaces} to \ac{VHDL} harder.
                    Before settling for the natural number indices on Π-Ware, another alternative
                ...
                \item[Lack of a "sum" constructor]
                    ...
                    will build a circuit which has the \emph{product} \AB{α} \AD{×} \AB{β} as its input.
                ...
                \item[Single fundamental gate vs. \emph{gate library}]
                    ...
                    which has attached specification functions to each of its elements,
