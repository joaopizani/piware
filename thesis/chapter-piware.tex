...
\label{chap:piware}
    ...
    \label{sec:proving-circuit-properties}
        ...
        \label{subsec:functional-correctness}
            ...
            %% TODO: talk about proving families of circuits? try pidN or show only statement

            
        \subsection{Sequential correctness}
        \label{subsec:sequential-correctness}

            %% TODO: register example?
            %% TODO: "hardcoded" statement and proof about register
            %% TODO: generic inputs statement (and proof?) for register
