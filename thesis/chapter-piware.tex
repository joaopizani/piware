...
\label{chap:piware}
    ...
    \label{sec:proving-circuit-properties}
        ...
        \label{subsec:functional-correctness}
            ...
            \draftnote{TODO: talk about proving families of circuits (proof by induction). Use pidN or andN.}
        ...
        \label{subsec:sequential-correctness}
            ...
            \draftnote{TODO: show and explain example of register circuit.}

            \draftnote{TODO: show statement and proof of some examples of register behviour.}
