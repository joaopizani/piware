...
\label{chap:piware}
    ...
    \label{sec:circuit-semantics}
        ...
        \label{subsec:sequential-eval}
            ...
            This auxiliary step function (named \AF{⟦\_⟧ᶜ}) is shown in Listing~\ref{lst:eval-causal}.
            ...
            \begin{listing}[h]
                ...
                \newline
                \centering{\ExecuteMetaData[agda/latex/PiWare/Simulation/Core.tex]{eval-causal}}
                \caption{Causal step function.\label{lst:eval-causal}}
            \end{listing}
