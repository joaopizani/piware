...
\label{chap:piware}
    ...
    \label{sec:circuit-syntax}
        ...
        \subsection{Design discipline enforced by circuit constructors}
            ...
            %% TODO: example of dangerous combinational loop by mistake?
            ...
            \begin{itemize}
                ...
                \item Combinational simulation (ignoring past inputs) only happens when
                    the circuit is provably cycle-free, thus stateless.
            \end{itemize}
    ...
    \label{sec:circuit-abstraction}
        ...
        \label{subsec:atoms}
            ...
            The \AD{Atomic} record (shown in Listing~\ref{lst:atomic})
    ...
    \label{sec:circuit-semantics}
        ...
        \label{subsec:sequential-eval}
            ...
            %% TODO: high-level sequential simulation
