...
\label{chap:piware}
    ...
    \label{sec:proving-circuit-properties}
        ...
        In this section we focus mainly on statements and proofs involving circuits's
        ...
        \label{subsec:functional-correctness}
            ...
            (listing all possible input combinations) or using Agda's boolean functions.
            The style in which the specification is written can influence the correctness proof.
