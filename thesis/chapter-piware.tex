...
\label{chap:piware}
    ...
    \label{sec:circuit-abstraction}
        ...
        \label{subsec:atoms}
            ...
            \begin{description}
                ...
                \item[Numeric types]
                    ...
                    (\mintinline{haskell}{}, \mintinline{}{}, etc.).
            ...
            the \AD{⇓W⇑} (\texttt{Synthesizable}) type class, detailed in Section~\ref{subsec:synthesizable}.
        ...
        \label{subsec:high-level-circuit}
            ...
            which are \emph{instances} of the \AD{⇓W⇑} type class (pronounced \texttt{Synthesizable}),
        ...
        \label{subsec:synthesizable}
            ...
            Ultimately, given the experience we had in writing these proofs for some of the \AD{⇓W⇑} instances predefined
    ...
    \label{sec:proving-circuit-properties}
        ...
        There are two main reasons for wanting to embed Π-Ware embedded in a dependently-typed
        ...
        While in the previous section we focused on how Π-Ware makes use of dependent types to
        prevent some classes of mistakes early in the design process, in this section we show
        what kind of \emph{proofs involving circuits} are possible in Π-Ware and how
        they work.
        ...
        \label{subsec:functional-correctness}
            ...
            \subsubsection{Sequential correctness}
            \label{subsubsec:sequential-correctness}
