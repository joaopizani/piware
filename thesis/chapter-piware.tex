...
\label{chap:piware}
    ...
    \label{sec:circuit-semantics}
        ...
        \label{subsec:sequential-eval}
            ...
            The type of a "normal" stream function (\AD{Stream} \AB{α} \AY{→} \AD{Stream} \AB{β})
            can be read as:
            ...
            As such, it has no notion of \emph{current} value, neither of past, and it \emph{can}
            "look ahead", that is, use future input values to calculate the next output value.
