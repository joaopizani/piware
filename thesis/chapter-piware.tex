...
\label{chap:piware}
    ...
    \label{sec:proving-circuit-properties}
        ...
        \label{subsec:functional-correctness}
            ...
            Proofs can also be written regarding whole parameterized \emph{families of circuits}.
            For example, we can have a definition for a generically-sized \texttt{AND} gate,
            as follows:

            \begin{center}
                % \ExecuteMetaData[code/agda/latex/PiWare/Samples/AndN.tex]{andN}
                Hallo
            \end{center}
            ...
            \begin{center}
                % \ExecuteMetaData[code/agda/latex/PiWare/ProofSamples/AndN.tex]{proof-andN-alltrue}
                All true.
            \end{center}

            %% TODO: talk about proving families of circuits (proof by induction). Use pidN or andN.}
        ...
        \label{subsec:sequential-correctness}
            ...
            Register sample in Listing~\ref{lst:register}.

            \begin{listing}[h]
                \centering{\ExecuteMetaData[code/agda/latex/PiWare/Samples/BoolTrioSeq.tex]{reg}}
                \caption{Sample register circuit description.\label{lst:register}}
            \end{listing}

            With block diagram in Figure~\ref{fig:register}.

            \begin{figure}[h]
                \includegraphics[width=0.9\textwidth]{imgs/register.pdf}
                \caption{Block diagram for the register described in Listing~\ref{lst:register}.
                    \label{fig:register}}
            \end{figure}
