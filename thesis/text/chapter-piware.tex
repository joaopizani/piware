...
\label{chap:piware}
        ...
        \subsection{Design discipline enforced by circuit constructors}
            ...
            \begin{description}
                ...
                \item [No short-circuits] The \AI{Plug} constructor, the only one which can be used for
                    ...
                    \begin{figure}[h]
                        \centering{\includegraphics[width=0.9\textwidth]{imgs/plug-seq-disconnected-input.pdf}}
    ...
    \label{sec:circuit-semantics}
        ...
        \label{subsec:sequential-eval}
            ...
            In the sum (\AI{\_|+'\_}) case, the past part of the context is segregated into a product
            ...
            These two segregated pasts are then passed as the pasts of \AB{c₁} and \AB{c₂}, respectively.
            ...
            the "segregation" becomes easy: in case the input context
            ...
            Bart Jacobs's "Introduction to coalgebra"~\shortcite{introduction-coalgebra-jacobs}.
            ...
            and the reader is directed to the paper
            describing Agda's implementation~\cite{coinductive-inductive-termination} for more information.
    ...
    \label{sec:proving-circuit-properties}
        ...
        \begin{itemize}
            ...
            \item With a \emph{synthesis} semantics, on the other hand,
                properties about circuit \emph{structure} can be stated and proven.
                For example, we can state that a circuit never exceeds a certain number of fundamental gates,
                or that the \emph{longest chain} of gates is never longer than a desired length.
            \item Furthermore, several other sorts of static analyses can be performed with the
                introduction of new semantics, such as timing analysis, power estimation, etc.
        \end{itemize}
        ...
        \label{subsec:functional-correctness}
            In hardware design, there are two closely related activities aiming to ensure the
            ...
            IEEE standard~\shortcite{ieee-pmbok} in 2011.
            ...
            We apply the same \emph{correctness} terminology to hardware, therefore
            we are interested in showing the \emph{correctness of circuits}.

            More specifically, we focus on establishing correctness through \emph{formal verification}.
            ...
            In Π-Ware's case, the circuit model (element of \AD{ℂ}) is considered the \emph{implementation},
            ...
            If we use the truth table specification, then the proof can only proceed by \emph{case analysis},
            ...
            they still have to be listed exhaustively.
            ...
            whenever all inputs are \AI{true}, the output must be \AI{true}, regardless of the number of inputs.
            ...
            Therefore its \emph{specification function} is the one defined in
            the \AM{BoolTrio} \emph{gate library}, named \AF{spec-and}.
        ...
        \label{subsec:sequential-correctness}
            ...
            This, in fact, applies to all sequential circuits: they all result in netlists with two extra
            ...
            Lastly, this multiplexer is wrapped by \AI{Plug}s that serve only to change the
            ...
            clock cycles the "load" pin is kept high. After that, a change in input does not cause a
            change in output.
            ...
            Terms which we would intuitively expect to be equal have \emph{suspension points}
            ...
            Thus, a proof of bisimilarity can also be seen as a \emph{stream of equality proofs},
