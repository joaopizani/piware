...
\label{chap:intro}
    ...
    %%     In which way can dependent types make circuit design a more precise and efficient activity?
    %%     We develop an EDSL for hardware - Π-Ware - embedded in the DT language Agda
    %%         Characteristics of Π-Ware:
    %%             Deep-embedded
    %%             Synthesis to netlists
    %%             Simulation semantics
    %%             Low AND high level of data abstraction
    %%             Prove STRONG properties (first-order logic) about circuit behaviour interactively
