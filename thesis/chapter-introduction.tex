...
\label{chap:intro}
    %% TODO: explain factors
    %% TODO: citation to support factors
    ...
    %% TODO: citation to support claim of improved productivity with FP (Mary Sheeran survey?)
    ...
    %% TODO: citation to support "have been confirmed in practice"
    These advantages of functional programming have been confirmed in practice -- and
    ...
    \begin{itemize}
        ...
        \item The concept of \emph{nullable type}\footnote{\url{http://msdn.microsoft.com/en-us/library/1t3y8s4s.aspx}}
            in C\#, which is equivalent to Haskell's \mintinline{haskell}{Maybe}.
    ...
    %% TODO: why isn't Haskell good enough? Cite Power of Π?
